...
import {
  parseSlotList, checkDuplicates,
  type ParseResult, type ParsedSlot, type ExistingTeam
...
const SAMPLE_MESSAGES = [
  {
    label: "SLOT format",
    text: `Ã°Å¸â€œâ€¹ SLOT LIST Ã¢â‚¬â€ Friday Scrim
...
export default function DiscordSlotImporter({ tournament, onClose, onSave }: DiscordSlotImporterProps) {
  ...
  const dupCheck = parseResult ? checkDuplicates(editableSlots, existingTeams) : null;

  // Ã¢â€â‚¬Ã¢â€â‚¬ Actions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/80 backdrop-blur-sm overflow-y-auto py-4 sm:py-8">
      <div className="glass-card w-full max-w-3xl mx-3 sm:mx-4 rounded-2xl border border-white/10 shadow-2xl">
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Step Indicator Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="text-xs text-gray-400">
                  ...
                  <div className="font-mono text-gray-500 space-y-0.5">
                    ...
                    <div>1. Team Name  Ã¢â‚¬Â¢  1 - Team Name  Ã¢â‚¬Â¢  1) Team Name</div>
                    <div>S1 Team Name  Ã¢â‚¬Â¢  #1 Team Name  Ã¢â‚¬Â¢  Slot 1: Team Name</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="p-3 rounded-xl bg-yellow-500/5 border border-yellow-500/15 space-y-1.5">
                ...
                <div className="space-y-0.5 max-h-24 overflow-y-auto">
                  {parseResult.warnings.slice(0, 8).map((w, i) => (
                    <p key={i} className="text-xs text-yellow-300/80">Ã¢â‚¬Â¢ {w.message}</p>
                  ))}
                </div>
              </div>
            )}
