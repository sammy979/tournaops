          ...
          <div className="lg:col-span-3">
            {sent ? (
              <div className="bg-[#0f1117] border border-emerald-500/20 rounded-2xl p-12 text-center">
                ...
                <button onClick={() => setSent(false)} className="bg-violet-600 hover:bg-violet-500 text-white px-6 py-2.5 rounded-xl font-semibold transition-colors">Send Another</button>
              </div>
            ) : (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select value={form.topic} onChange={e => upd("topic",e.target.value)}
                      className="w-full bg-[#0f1117] border border-white/[0.08] rounded-xl px-4 py-2.5 text-white text-sm focus:outline-none focus:border-violet-500/50">
