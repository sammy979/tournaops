    ...
    <div className="min-h-screen bg-[#060810] text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mt-12 p-5 bg-[#0f1117] border border-white/[0.06] rounded-2xl">
          <p className="text-white/40 text-sm">Questions about our terms? <Link href="/contact" className="text-yellow-500 hover:text-yellow-500 transition-colors">Contact us</Link> or email <span className="text-yellow-500">legal@tournaops.com</span></p>
        </div>
      </div>
