...
export default function TournamentBulkImportPage() {
    ...
    <DashboardShell>
      <div className="min-h-screen bg-[#080a0e] text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-slate-400 text-lg font-medium">Bulk import coming soon</p>
          <p className="text-slate-600 text-sm mt-1">Import teams and match data from CSV or spreadsheet</p>
        </div>
      </div>
    </DashboardShell>
  );
