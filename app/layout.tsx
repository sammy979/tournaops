...
export const metadata: Metadata = {
  ...
  description: "Nepal number 1 PUBG Mobile tournament management platform. Create brackets, manage teams, run overlays, accept Khalti and eSewa payments. Built for Nepali esports organizers.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Nepal number 1 PUBG Mobile tournament management platform. Khalti and eSewa payments. Real-time overlays. Team management.",
    images: [
      {
        url: "/logo.png",
        width: 1200,
  ...
  twitter: {
    ...
    title: "TournaOps - PUBG Mobile Tournament Manager Nepal",
    description: "Nepal number 1 PUBG Mobile tournament management platform.",
    images: ["/logo.png"],
    creator: "@tournaops",
  },
  icons: {
