...
export default async function HomePage() {
  ...
  const totalTournaments = stats[0];
  const totalUsers = stats[1];
  const totalTeams = stats[2];
    ...
    <main style={{
      ...
      <section style={{ padding: "4rem 2rem" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{
            ...
            {session && (
              <Link href="/dashboard/tournaments/new" style={{
              ...
              {recentTournaments.map((t) => (
                ...
                >
                  ...
                  <div style={{
                    ...
                    {t.startDate && (
                      <span>
                        {new Date(t.startDate).toLocaleDateString("en-NP", {
                          month: "short",
                          day: "numeric",
                        })}
                      </span>
      ...
      <section style={{
        ...
        <p style={{
          ...
          Pay via Khalti, eSewa, or Bank Transfer.
